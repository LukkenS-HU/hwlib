...
namespace RP2040
{
    ...
    {
    protected:
        explicit rp2040_pin_base(RP2040Pin pinNumber, bool output)
        : _pinNumber(pinNumber)
        {
            gpio_set_dir(pinNumber, output);
        }

        [[nodiscard]]
        RP2040Pin GetPinNumber() const
        { return _pinNumber; }

        void SetPinNumber(RP2040Pin value)
        { _pinNumber = value; }

    private:
        RP2040Pin _pinNumber;
    };

    class pin_in : public virtual rp2040_pin_base, public hwlib::pin_in
    {
    public:
        explicit pin_in(RP2040Pin pinNumber)
        : rp2040_pin_base(pinNumber, false)
        {}
    ...
    {
    public:
        explicit pin_out(RP2040Pin pinNumber)
        : rp2040_pin_base(pinNumber, true)
        {}
