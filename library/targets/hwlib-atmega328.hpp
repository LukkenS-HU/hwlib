...
namespace atmega328
{
    ...
    volatile uint8_t& HWLIB_WEAK
    port_data( uint_fast8_t
    port )
{
    switch( port )
{
...
void HWLIB_WEAK
configure_as_gpio( uint_fast8_t
port,
uint_fast8_t pin
){
if( port == 3 ){
